...
#if false
        EnhancedGraphics.DebugPrint($"{renderingData.CameraData.Camera.name}\n" +
            $"  display={renderingData.CameraData.NonScaledCameraTargetViewportSize} render={renderingData.CameraData.ScaledCameraTargetViewportSize} scale={renderingData.CameraData.RenderScale}\n" +
            $"  canApplyPipelineChanges={Util.CanApplyPipelineChanges(renderingData.CameraData)}\n" +
            $"  cameraResolveRequired={renderingData.CameraData.CameraResolveRequired} cameraResolveTargetBufferType={renderingData.CameraData.CameraResolveTargetBufferType}\n" +
            $"  renderTargetBufferType={renderingData.CameraData.CameraRenderTargetBufferType}\n" +
            $"  scalingMode={renderingData.CameraData.ScalingMode}\n" +
            $"  upscalingFilter={renderingData.CameraData.UpscalingFilter}\n"
        );
#endif
...
public static class PatchCameraColorBufferAccess {
    ...
    private static void ScriptableRenderer_Execute_Impl(ScriptableRenderPass pass, ref RenderingData data) {
        ...
        _dispatchedUpscale = _dispatchedUpscale || pass is UpscalePass;
    }
